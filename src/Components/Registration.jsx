            ...
            <section className='w-full min-h-screen mx-auto py-10'>
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
                    ...
                    <form onSubmit={handleSignUp} action="" className="space-y-7">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className='relative'>
                                <input type="email" name="email" id="email" placeholder="ئېلخەت" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring text-end" />
                                <svg className='absolute top-1/2 -translate-y-1/2 left-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className='relative'>
                                ...
                                <svg className='absolute top-1/2 -translate-y-1/2 left-2' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 24 24">
