                    ...
                    <form onSubmit={handleOtp} className="space-y-7">
                        <div className="space-y-2 text-sm">
                            <div className='relative'>
                                <input type="text" name="otp" id="otp" placeholder="ئېلخەتكە كەلگەن پارول" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring text-right"  dir="rtl"/>
